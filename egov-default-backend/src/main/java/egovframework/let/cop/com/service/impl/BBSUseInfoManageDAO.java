...
public class BBSUseInfoManageDAO extends EgovAbstractMapper {
    ...
    public List<BoardUseInf> selectBBSUseInfByCmmnty(BoardUseInfVO bdUseVO)
        throws Exception {
        return (List<BoardUseInf>) list(
            "BBSUseInfoManageDAO.selectBBSUseInfByCmmnty",
            bdUseVO
        );
    }
    ...
    public List<BoardUseInf> selectBBSUseInfByClub(BoardUseInfVO bdUseVO)
        throws Exception {
        return (List<BoardUseInf>) list(
            "BBSUseInfoManageDAO.selectBBSUseInfByClub",
            bdUseVO
        );
    }
    ...
    public List<BoardUseInfVO> selectBBSUseInfs(BoardUseInfVO bdUseVO)
        throws Exception {
        return (List<BoardUseInfVO>) list(
            "BBSUseInfoManageDAO.selectBBSUseInfs",
            bdUseVO
        );
    }
    ...
    public int selectBBSUseInfsCnt(BoardUseInfVO bdUseVO) throws Exception {
        return (Integer) selectOne(
            "BBSUseInfoManageDAO.selectBBSUseInfsCnt",
            bdUseVO
        );
    }
    ...
    public BoardUseInfVO selectBBSUseInf(BoardUseInfVO bdUseVO)
        throws Exception {
        return (BoardUseInfVO) selectOne(
            "BBSUseInfoManageDAO.selectBBSUseInf",
            bdUseVO
        );
    }
    ...
    public List<BoardUseInfVO> selectBBSUseInfsByTrget(BoardUseInfVO bdUseVO)
        throws Exception {
        return (List<BoardUseInfVO>) list(
            "BBSUseInfoManageDAO.selectBBSUseInfsByTrget",
            bdUseVO
        );
    }
    ...
    public int selectBBSUseInfsCntByTrget(BoardUseInfVO bdUseVO)
        throws Exception {
        return (Integer) selectOne(
            "BBSUseInfoManageDAO.selectBBSUseInfsCntByTrget",
            bdUseVO
        );
    }
