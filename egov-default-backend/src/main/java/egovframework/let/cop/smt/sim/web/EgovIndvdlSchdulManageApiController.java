...
public class EgovIndvdlSchdulManageApiController {
    ...
    public ResultVO EgovIndvdlSchdulManageMonthList(
        ...
        resultMap.put(
            "searchKeyword",
            commandMap.get("searchKeyword") == null
                ? ""
        ...
        if (sYear == null || sMonth == null) {
            ...
            sSearchDate +=
                Integer.toString(iMonth + 1).length() == 1
                    ? "0" + Integer.toString(iMonth + 1)
        ...
        resultMap.put(
            "resultList",
            egovIndvdlSchdulManageService.selectIndvdlSchdulManageRetrieve(
                commandMap
            )
        );
    ...
    public ResultVO IndvdlSchdulManageRegistActor(
        ...
        if (bindingResult.hasErrors()) {
            ...
            resultVO.setResultMessage(
                ResponseCode.INPUT_CHECK_ERROR.getMessage()
            );
            return resultVO;
        }
        ...
        egovIndvdlSchdulManageService.insertIndvdlSchdulManage(
    ...
    public ResultVO EgovIndvdlSchdulManageDetail(
        ...
        IndvdlSchdulManageVO scheduleDetail = egovIndvdlSchdulManageService.selectIndvdlSchdulManageDetail(
            indvdlSchdulManageVO
        );
        ...
        // 첨부파일 확인
        if (
            scheduleDetail.getAtchFileId() != null &&
            !scheduleDetail.getAtchFileId().isEmpty()
        ) {
                    ...
                    Base64
                        ...
                        .encodeToString(
                            cryptoService.encrypt(
                                toEncrypt.getBytes(),
                                EgovFileDownloadController.ALGORITM_KEY
                            )
                        )
                );
            }
    ...
    public ResultVO EgovIndvdlSchdulManageDelete(
        ...
        egovIndvdlSchdulManageService.deleteIndvdlSchdulManage(
            indvdlSchdulManageVO
        ); //schdulId
    ...
    public ResultVO IndvdlSchdulManageModifyActor(
		...
		****************************************************************** */
		...
		// 일정관리정보 업데이트 처리
		****************************************************************** */
        egovIndvdlSchdulManageService.updateIndvdlSchdulManage(
            indvdlSchdulManageVO
        );
