...
public class EgovBBSManageApiController {
    ...
    public ResultVO selectUserBBSMasterInf(
        ...
        masterFileAtchInfo.setPosblAtchFileNumber(
            master.getPosblAtchFileNumber()
        );
    ...
    public ResultVO selectBoardArticles(
        ...
        paginationInfo.setRecordCountPerPage(
            propertyService.getInt("Globals.pageUnit")
        );
        ...
        Map<String, Object> resultMap = bbsMngService.selectBoardArticles(
            boardVO,
            vo.getBbsAttrbCode()
        );
    ...
    public ResultVO selectBoardArticle(
        ...
        if (
            vo != null &&
            vo.getAtchFileId() != null &&
            !vo.getAtchFileId().isEmpty()
        ) {
    ...
    public ResultVO updateBoardArticle(
        ...
        boardVO.setPassword(
            EgovFileScrty.encryptPassword("", user.getUniqId())
        ); // dummy 오류 수정 (익명이 아닌 경우 validator
        // 처리를 위해 dummy로 지정됨)
    ...
    public ResultVO insertBoardArticle(
        final MultipartHttpServletRequest multiRequest,
        BoardVO boardVO,
        BindingResult bindingResult,
        HttpServletRequest request
    ...
    public ResultVO replyBoardArticle(
        final MultipartHttpServletRequest multiRequest,
        BoardVO boardVO,
        BindingResult bindingResult,
        HttpServletRequest request
        ...
        boardVO.setReplyLc(
            Integer.toString(Integer.parseInt(boardVO.getReplyLc()) + 1)
        );
