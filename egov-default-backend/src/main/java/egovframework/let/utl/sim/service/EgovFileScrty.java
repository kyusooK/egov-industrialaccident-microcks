...
public class EgovFileScrty {
    ...
    public static boolean encryptFile(String source, String target)
        ...
        String sourceFile = EgovWebUtil.filePathBlackList(
            source.replace("\\", FILE_SEPARATOR).replace("/", FILE_SEPARATOR)
        );
        String targetFile = EgovWebUtil.filePathBlackList(
            target.replace("\\", FILE_SEPARATOR).replace("/", FILE_SEPARATOR)
        );
