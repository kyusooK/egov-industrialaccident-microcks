...
public class EgovFileUploadUtil extends EgovFormBasedFileUtil {
	...
	*/
     ...
     * @throws Exception
     */
    public static List<EgovFormBasedFileVo> uploadFilesExt(
        ...
        if (mptRequest != null) {
            ...
            while (fileIter.hasNext()) {
                MultipartFile mFile = mptRequest.getFile(
                    (String) fileIter.next()
                );
    ...
    public static String getFileExtension(String fileNamePath) {
        ...
        String ext = fileNamePath.substring(
     ...
     * @return true : 불가
     */
    public static boolean checkFileExtension(
        String fileNamePath,
     ...
     * @return true : 불가
     */
    public static boolean checkFileMaxSize(
