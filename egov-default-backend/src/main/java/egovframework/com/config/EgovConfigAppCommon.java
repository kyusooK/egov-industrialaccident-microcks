...
public class EgovConfigAppCommon {
    ...
    public DefaultTraceHandleManager traceHandlerService() {
        ...
        defaultTraceHandleManager.setHandlers(
            new TraceHandler[] { defaultTraceHandler() }
        );
    ...
    public EgovPasswordEncoder egovPasswordEncoder() {
        ...
        egovPasswordEncoder.setHashedPassword(
            "gdyYs/IZqY86VcWhT8emCYfqY1ahw2vtLG+/FzNqtrQ="
        );
